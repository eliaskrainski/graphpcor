...
1. local clone repository
   a) R CMD build then R CMD INSTALL 
   b) within Rstudio: <Ctrl+Shift+B>
2. from this source with the github token
  (obtain the token at Github account settings: click on <Developer settings>, then <Personal access tokens>, and select <Tokens (classic)> and following the steps.)
  ```
