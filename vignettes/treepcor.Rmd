...
# Implementation with $\textbf{\textsf{graphpcor}}$
...
round(cov(xx), 2)
``` 
and the fitted covariance (from posterior mode)
```{r Vfitg, eval = haveINLA}
