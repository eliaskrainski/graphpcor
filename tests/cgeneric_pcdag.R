...
### for concepts: test/concepts/pcdag.R
### for details: tests/check/check_pcdag.R
### for details: tests/detailed/detailed_pcdag.R
...
## define the cgeneric model (see test/concepts/pcdag.R for other options)
